...
class ControllerCommonPostCodepro extends Controller {
	...
	protected function index() {
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/common/postcodepro')) {
			 $this->template = $this->config->get('config_template') . '/template/common/postcodepro';
			 } else { 
			 $this->template = 'default/template/common/postcodepro';
		}
	}	
