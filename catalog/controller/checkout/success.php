...
class ControllerCheckoutSuccess extends Controller {
	public function index() {
	    ...
	    $message ="We have received your order.Your Order id is :".$_SESSION['order_id'] ." Thank You for shopping with us-Signature Online Shop-9552873857.www.signatureshop.com";
