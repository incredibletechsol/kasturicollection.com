...
class ControllerCommonColumnLeft extends Controller {
	public function index() {
		if (isset($this->request->get['user_token']) && isset($this->session->data['user_token']) && ($this->request->get['user_token'] == $this->session->data['user_token'])) {
			...
			if ($this->user->hasPermission('access', 'localisation/payselect')) {
				$payconfirm[] = array(
					'name'	   => $this->language->get('text_payselect'),
					'href'     => $this->url->link('localisation/payselect', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);		
			}
			...
			if ($payconfirm) {	
				$localisation[] = array(
					'name'	   => $this->language->get('text_payconfirm'),
					'href'     => '',
					'children' => $payconfirm		
				);
			}
