...
class ControllerSellerCategory extends Controller { 
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			if ( $this->config->get('config_category_autoapprove') == '1') {
	...
	private function getList() {
		...
		$data['text_category_approved'] = $this->language->get('text_category_approved');
		$data['text_category_not_approved'] = $this->language->get('text_category_not_approved');
