...
if($this->config->get('module_landmark_status')){
				$this->db->query("INSERT " . DB_PREFIX . "address_landmark SET address_id = '" . (int)$this->db->getLastId() . "',landmark='".$this->db->escape($address['landmark'])."'");
				}
...
if($this->config->get('module_landmark_status')){
				$this->db->query("DELETE FROM " . DB_PREFIX ."address_landmark WHERE address_id IN (SELECT address_id FROM " . DB_PREFIX ."address WHERE customer_id='". (int)$customer_id ."')");
				}
...
if($this->config->get("module_landmark_status")){
				$landmark_query = $this->db->query("SELECT * FROM `" . DB_PREFIX . "address_landmark` WHERE address_id = '" . (int)$address_id . "'");
