...
class ControllerSaleOrder extends Controller {
	...
	protected function getList() {
		...
		$data['text_select_update_status'] = $this->language->get('text_select_update_status');

		$this->document->addStyle('view/javascript/summernote/summernote.css');
		$this->document->addScript('view/javascript/summernote/summernote.js');
		$this->document->addScript('view/javascript/summernote/opencart.js');
	  
		$this->document->addStyle('view/stylesheet/module/order_status_updater.css');
		$this->document->addScript('view/javascript/module/order_status_updater.js');

		$data['order_status_updater'] = $this->load->controller('extension/module/order_status_updater/action');
...
$data['payment_landmark'] = $order_info['payment_landmark'];
...
$this->load->language('extension/module/landmarklang');
            	$data['landmark_status'] = $this->config->get('module_landmark_status');
...
'landmark' => (isset($order_info['payment_landmark']) ? $order_info['payment_landmark'] : ''),
...
'landmark' => (isset($order_info['shipping_landmark']) ? $order_info['shipping_landmark'] : ''),
