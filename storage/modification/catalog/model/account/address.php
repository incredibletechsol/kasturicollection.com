...
if(isset($data['landmark']) && $this->config->get("module_landmark_status")){
					$this->db->query("INSERT " . DB_PREFIX . "address_landmark SET address_id = '" . (int)$address_id . "',landmark='".$this->db->escape($data['landmark'])."'");
					}
...
if($this->config->get("module_landmark_status")){
				$this->db->query("UPDATE " . DB_PREFIX . "address_landmark SET landmark = '" . $data['landmark'] . "' WHERE address_id = '" . (int)$address_id . "'");
				}
...
if($this->config->get("module_landmark_status")){
				$landmark_query = $this->db->query("SELECT * FROM `" . DB_PREFIX . "address_landmark` WHERE address_id = '" . (int)$address_query->row['address_id'] . "'");
			
				if ($landmark_query->num_rows) {
					$landmark = $landmark_query->row['landmark'];
				} else {
					$landmark = '';
				}
			}else{
...
if($this->config->get("module_landmark_status")){
				$landmark_query = $this->db->query("SELECT * FROM `" . DB_PREFIX . "address_landmark` WHERE address_id = '" . (int)$result['address_id'] . "'");
