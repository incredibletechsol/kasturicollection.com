...
if($this->config->get('module_landmark_status')){
				$this->db->query("INSERT INTO `" . DB_PREFIX . "order_landmark` SET order_id = '" . $order_id."' , payment_landmark = '" . $this->db->escape($data['payment_landmark']) . "', shipping_landmark = '" . $this->db->escape($data['shipping_landmark']) . "'");
				}
...
if($this->config->get('module_landmark_status')){
			$this->db->query("UPDATE `" . DB_PREFIX . "order_landmark` SET payment_landmark = '" . $this->db->escape($data['payment_landmark']) . "', shipping_landmark = '" . $data['shipping_landmark'] . "' WHERE order_id = '" . (int)$order_id . "'");
	    }
...
if($this->config->get('module_landmark_status')){
				$landmark_query = $this->db->query("SELECT * FROM `" . DB_PREFIX . "order_landmark` WHERE order_id = '" . (int)$order_query->row['order_id'] . "'");

				if ($landmark_query->num_rows) {
					$payment_landmark = $landmark_query->row['payment_landmark'];
					$shipping_landmark = $landmark_query->row['shipping_landmark'];
				} else {
					$payment_landmark = '';
					$shipping_landmark = '';
				}
...
'payment_landmark'       => $payment_landmark,
