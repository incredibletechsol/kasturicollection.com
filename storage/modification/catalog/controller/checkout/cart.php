...
$this->load->language('checkout/product_maximum');
 ...
 $this->load->language('checkout/outofstock');
					      $data['error_message'] = $this->language->get('error_message'); 
$data['status']=$this->config->get('module_outofstocknotification_status');
...
$module_maximum_status = $this->config->get('module_maximum_status');
					
if($module_maximum_status == 1){
