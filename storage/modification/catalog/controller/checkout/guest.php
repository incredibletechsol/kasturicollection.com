...
if (isset($this->session->data['payment_address']['landmark'])) {
...
$this->load->language('extension/module/landmark');
...
if($this->config->get('module_landmark_status')){
				if ((utf8_strlen(trim($this->request->post['landmark'])) < 3) || (utf8_strlen(trim($this->request->post['landmark'])) > 128)) {
				$this->load->language('extension/module/landmark');
...
if($this->config->get('module_landmark_status')){
				$this->session->data['payment_address']['landmark'] = $this->request->post['landmark'];
				}
...
if($this->config->get('module_landmark_status')){
				$this->session->data['shipping_address']['landmark'] = $this->request->post['landmark'];
				}
